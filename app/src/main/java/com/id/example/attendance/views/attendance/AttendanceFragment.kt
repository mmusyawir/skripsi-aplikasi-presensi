package com.id.example.attendance.views.attendance
...
import com.id.example.attendance.databinding.BottomSheetAttendanceBinding
import com.id.example.attendance.databinding.FragmentAttendanceBinding
...
class AttendanceFragment : Fragment(), OnMapReadyCallback {
    ...
    private fun sendDataAttendance(token: String, type: String) {
        ...
        if (currentLocation != null && currentPhotoPath.isNotEmpty()){
            ...
            params["long"] = requestLatitude
            params["lat"] = requestLongitude
            ...
            .enqueue(object : Callback<HistoryResponse>{
                override fun onResponse(
                    ...
                    if (response.isSuccessful){
                        ...
                        Log.e(TAG, "History response: $historyResponse")
                        val histories = response.body()?.histories
                        Log.e(TAG, "History: $histories")
    ...
    private fun checkIsCheckIn() {
        Log.i(TAG, "is nilai check in: $isCheckIn")
        if (isCheckIn){
